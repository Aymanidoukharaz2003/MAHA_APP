        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('personnel.echantillon.store',['email' => Auth::user()->email]) }}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="terminer" id="oui" value="oui" checked>
                                <label class="form-check-label" for="oui" style="color: green">Oui</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="terminer" id="non" value="non">
...
@section('js')
        ...
        $(document).ready(function() {
            ...
            $('#projet_id').change(function() {
                ...
                if (projetId) {
                    $.ajax({
                        url: '{{ route("fetch.products.by.project") }}',
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            projet_id: projetId
