...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">Modifier Personnel</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">Admin</a></li>
                <li class="breadcrumb-item active">Modifier Personel</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post"  action="{{ route('Personnel.modifier') }}" autocomplete="off" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input  type="password" name="password" class="form-control" value="{{$personnel->password}}" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input  type="text" name="adresse" class="form-control" value="{{$personnel->adresse}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <label>CIN:</label>
                                <input class="form-control" type="text"  name="cin" value="{{$personnel->cin}}" >
                            </div>
                        </div>
