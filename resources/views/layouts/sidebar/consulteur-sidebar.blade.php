                   ...
                   <li class="mt-10 mb-10 text-muted pl-4 font-medium menu-title">Management des projets </li> 
                    ...
                    <li>
                        ...
                        <ul id="chart" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('consulteur.projets',['email' => Auth::user()->email]) }}">Listes Des Projets</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="font-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('consulteur.produits',['email' => Auth::user()->email])}}">Listes Des produits</a> </li>
                        </ul>
                    </li>
